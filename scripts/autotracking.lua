...
AUTOTRACKER_ENABLE_DEBUG_LOGGING_UTILS = true and AUTOTRACKER_ENABLE_DEBUG_LOGGING
AUTOTRACKER_ENABLE_DEBUG_LOGGING_ITEMS = true and AUTOTRACKER_ENABLE_DEBUG_LOGGING
...
AUTOTRACKER_ENABLE_DEBUG_LOGGING_DOORS = true and AUTOTRACKER_ENABLE_DEBUG_LOGGING
